...
public class PendidikanActivity extends AppCompatActivity {
    ...
    private void loadDonasiDummy() {
        ...
        donasiList.clear();
        donasiList.add(new Donasi(1, "Donasi Pendidikan A", "Deskripsi donasi pendidikan A", "Pendidikan", 500000, "image_a", "email@example.com"));
        donasiList.add(new Donasi(2, "Donasi Pendidikan B", "Deskripsi donasi pendidikan B", "Pendidikan", 750000, "image_b", "email@example.com"));
    ...
    private void hapusDonasi(Donasi donasi) {
        ...
        builder.setPositiveButton("Ya", (dialog, which) -> {
            ...
            Toast.makeText(PendidikanActivity.this, "Donasi berhasil dihapus (simulasi)", Toast.LENGTH_SHORT).show();
        });
